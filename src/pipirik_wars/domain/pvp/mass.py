...
* Без ``random`` — pairing-функция и `resolve_mass_*` (см.
  `domain/pvp/mass_services.py`) принимают :class:`IRandom` извне;
  чистые VO в этом модуле никаких RNG-вызовов не делают.
