...
- [~] **B.0 — Обновить `current_tasks.md`** под старт Спринта 4.1-B: пересобрать «Снимок состояния» под актуальный `main = 21c21c0`, расписать чек-лист 4.1-B (был расписан в A.8), создать `AGENT_HANDOFF.md` (Checkpoint 1).
