...
- [ ] Дождаться мерджа `3.6-A` в `main` (PR #126, `<merge_3_6_A>`).
- [ ] `git fetch && git checkout main && git pull`.
- [ ] Создать ветку `devin/<новый_ts>-sprint-3-6-B-oracle-bot-ui` от свежего `main = <merge_3_6_A>`.
- [ ] **B.0 — Обновить `current_tasks.md`** под старт Спринта 3.6-B: пересобрать «Снимок состояния» под актуальный `main = <merge_3_6_A>`, расписать чек-лист 3.6-B, заархивировать чек-лист 3.6-A в `history.md` (этот коммит — Checkpoint 1).
...
**Текущий PR — 3.6-B «Bot UI + локали + закрытие Спринта 3.6»** — закрывающий PR Спринта 3.6. После мерджа PR #126 (3.6-A) — стартует от свежего `main = <merge_3_6_A>`.
- **На `main`:** 3.6-A смержен (PR #126, `<merge_3_6_A>`). 3.6-B будет открыт от свежего `main = <merge_3_6_A>`.
...
`<обновится после A.6 push>` — `docs(3.6-A): A.6 — history.md (Sprint 3.6-A entry) + current_tasks.md pivot to Sprint 3.6-B`.
