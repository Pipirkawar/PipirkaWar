...
**`make ci` локально на feature-ветке (после D.5 + D.9):** зелёный — 3145 passed / 1 skipped, coverage 95.19%.
...
| **CI статус** | зелёный локально на feature-ветке (после D.5 + D.9): `make ci` — 3145 passed / 1 skipped, coverage 95.19% |
