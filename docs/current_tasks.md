...
`5c92aad` — `feat(4.1-B): B.3 — persistence prize_pool_balance + Alembic 0027 + 13 integration-tests` (после ребейза 4.1-B на свежий main = da7100a, merge PR #129).
